...
* Led a team of seven engineers to implement Infrastructure as Code (IaC) using Terraform, Gitlab CI and Gitlab Runners, resulting in a 70% improvement in deployment efficiency and ensuring consistent environment configurations across multiple projects.  
